...
const Header: React.FC<HeaderProps> = React.memo(({ activeView, setActiveView }) => {
  ...
  const handleSettingsClick = useCallback(() => setActiveView('settings'), [setActiveView]);
          ...
          <div className="flex justify-between items-center h-14 sm:h-16">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <button
                ...
                className={`p-2 rounded-sm transition-colors focus:outline-none focus:ring-2 focus:ring-brass-500/50 ${activeView === 'settings'
